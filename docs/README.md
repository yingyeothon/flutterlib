...
2. [Console and options](console-and-options.md) — the four values the console hands
   you, and every option the clients take.
...
The gateway's wire protocol, the auth service's endpoints and the console are owned by
