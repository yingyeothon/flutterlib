...
///
/// Concurrent calls for one URL share one request; a success is kept for
/// the fetcher's life (a new map version is a new URL); a failure is evicted
/// so the next call retries. The cache entry is published before the work
/// starts, so a fetcher that fails synchronously still evicts the right
/// entry.
